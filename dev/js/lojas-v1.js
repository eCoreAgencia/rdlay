var lojas = {
    ...
    getLojas: function (shopId) {
        requestUrl = "https://api.vtexcrm.com.br/rdlay/dataentities/LJ/search?_fields=id,local,endereco,complemento,telefone,horario_semana,horario_sabado,latitude,longitude", shopId ? requestUrl += "&id=" + shopId : requestUrl += "&_sort=local", $.ajax({
            url: requestUrl,
            type: "GET",
            headers: {
